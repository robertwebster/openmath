...
export const metadata: Metadata = {
  title: "Year 10 | Open Math",
  description: "Year 10 NSW Mathematics practice topics — free, no account needed.",
};
...
function getTopicIds(): string[] {
  const base = path.join(process.cwd(), "content", "year-10");
  const dirs = fs
...
export default function Year10Page() {
  const topics = getTopicIds().map((id) => getTopicMeta(10, id));
  ...
  return (
    <div className="flex flex-col min-h-full">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full">
        ...
        <h1 className="text-3xl font-bold text-slate-900 mb-2 tracking-tight">Year 10</h1>
